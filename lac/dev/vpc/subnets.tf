...
resource "aws_subnet" "public_subnet_a" {
  ...
  tags = {
    Name = "010-000.public-subnet-a-${var.vpc_name}"
  }
}
...
resource "aws_subnet" "public_subnet_c" {
  ...
  tags = {
    Name = "010-002.public-subnet-c-${var.vpc_name}"
  }
}
...
resource "aws_subnet" "public_lb_subnet_a" {
  ...
  tags = {
    Name                                        = "010-010.public-lb-subnet-a-${var.vpc_name}",
...
resource "aws_subnet" "public_lb_subnet_c" {
  ...
  tags = {
    Name                                        = "010-012.public-lb-subnet-c-${var.vpc_name}",
    "kubernetes.io/role/elb"                    = "1",
    "kubernetes.io/cluster/${var.cluster_name}" = "shared"
  }
}
...
resource "aws_subnet" "private_subnet_a" {
  ...
  tags = {
    Name    = "010-100.private-subnet-a-${var.vpc_name}"
    Network = "Private"
...
resource "aws_subnet" "private_subnet_a2" {
  ...
  tags = {
    Name    = "010-110.private-subnet-a2-${var.vpc_name}"
    Network = "Private"
    "karpenter.sh/discovery" = var.cluster_name
  }
}
...
resource "aws_subnet" "private_subnet_b" {
  ...
  tags = {
    Name    = "010-101.private-subnet-b-${var.vpc_name}"
    Network = "Private"
    "karpenter.sh/discovery" = var.cluster_name
  }
}
...
resource "aws_subnet" "private_subnet_c" {
  ...
  tags = {
    Name    = "010-102.private-subnet-c-${var.vpc_name}"
    Network = "Private"
    "karpenter.sh/discovery" = var.cluster_name
  }
}
...
resource "aws_subnet" "private_subnet_d" {
  ...
  tags = {
    Name    = "010-103.private-subnet-d-${var.vpc_name}"
    Network = "Private"
    "karpenter.sh/discovery" = var.cluster_name
  }
}
...
resource "aws_subnet" "private_db_subnet_a" {
  ...
  tags = {
    Name    = "010-200.private-db-subnet-a-${var.vpc_name}"
    Network = "Private"
  }
}
...
resource "aws_subnet" "private_db_subnet_b" {
  ...
  tags = {
    Name    = "010-201.private-db-subnet-b-${var.vpc_name}"
    Network = "Private"
  }
}
...
resource "aws_subnet" "private_db_subnet_c" {
  ...
  tags = {
    Name    = "010-202.private-db-subnet-c-${var.vpc_name}"
    Network = "Private"
  }
}
...
resource "aws_subnet" "private_db_subnet_d" {
  ...
  tags = {
    Name    = "010-203.private-db-subnet-d-${var.vpc_name}"
    Network = "Private"
  }
}